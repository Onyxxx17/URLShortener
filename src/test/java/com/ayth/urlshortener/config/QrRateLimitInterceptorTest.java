...
class QrRateLimitInterceptorTest {

    private final RateLimitingService rateLimitingService = new RateLimitingService();
    private final QrRateLimitInterceptor interceptor = new QrRateLimitInterceptor(rateLimitingService);
    ...
    void preHandle_burstExhausted_returns429WithMessage() throws Exception {
        ...
        assertThat(response.getContentAsString())
                .isEqualTo("Too many requests from this IP for QR codes. Please try again later.");
    }
