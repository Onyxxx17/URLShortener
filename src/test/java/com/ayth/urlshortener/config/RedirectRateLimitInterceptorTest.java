...
class RedirectRateLimitInterceptorTest {

    private final RateLimitingService rateLimitingService = new RateLimitingService();
    private final RedirectRateLimitInterceptor interceptor = new RedirectRateLimitInterceptor(rateLimitingService);
    ...
    void preHandle_burstExhausted_returns429WithMessage() throws Exception {
        ...
        assertThat(response.getContentAsString())
                .isEqualTo("Too many redirect requests. Please try again later.");
    }
